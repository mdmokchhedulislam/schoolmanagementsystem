...
function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 px-6">
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl max-w-lg w-full p-10 relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
          ...
          <p className="mt-4 text-center text-sm text-slate-500 dark:text-slate-400">
            ...
            <Link to={"/login"}>     <span className="text-blue-600 hover:underline cursor-pointer">
              Login
            </span></Link>
